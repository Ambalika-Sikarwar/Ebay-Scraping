...
class Ui_MainWindow(object):
    ...
    def get_inventory(self, sku):
        ...
        try:
            ...
            params = {"sku": str(sku)}
            print(params)
            r = requests.get(url="https://marketplace.walmartapis.com/v3/inventory", params=params, headers=headers,
                             auth=HTTPBasicAuth(self.client_id, self.client_secret))
            str4 = r.text
            print(str4)
            import xml.etree.ElementTree as ET
    ...
    def get_item(self, sku):
        ...
        try:
            ...
            headers = {"WM_SEC.ACCESS_TOKEN": str(self.token), "WM_SVC.NAME": "Walmart Marketplace",
                       ...
                       'accept': "application/xml"}
            params = {"sku": str(sku)}
            r = requests.get(url="https://marketplace.walmartapis.com/v3/items/{}".format(sku), headers=headers,
                             auth=HTTPBasicAuth(self.client_id, self.client_secret))
            str5 = r.text
            import xml.etree.ElementTree as ET
    ...
    def setupUi(self, MainWindow):
        ...
        self.comboBox.addItems(["Version 1", "Version 2"])
